  ...
  const experiences = [
    {
      ...
      technologies: ["Python", "Java", "SQL", "Data Analysis", "Security", "Enterprise Systems"]
    },
    {
      ...
      technologies: ["Python", "Java", "Backend Development", "Data Integration", "System Optimization"]
    }
  ];
